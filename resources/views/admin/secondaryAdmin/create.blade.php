...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-9">
            <div class="card">
                <div class="card-header">Register SecondaryUser</div>
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.register.secondaryuser') }}">
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn btn-primary">Register SecondaryUser</button>
                            <button type="button" class="btn btn-secondary" onclick="window.location.href='/admin/secondaryuser';">Close</button>
                        </div>
                    </form>
                </div>
            </div>
